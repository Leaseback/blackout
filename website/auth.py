...
def login():
    try:
        ...
        flash('Unknown error has occured.', category='error')
...
def sign_up():
    if request.method == 'POST':
        ...
        if user:
            ...
            new_user = User(email=email, first_name=first_name, company_name = company_name, password=generate_password_hash(
